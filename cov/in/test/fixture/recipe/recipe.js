...
(function (i, l) {
  ...
  function y(e, J) {
    ...
    if (e.state === l) {
      ...
      e.onpreload = [];
      _$jscoverage['recipe.js'][19]++;
      c({url: e.url, type: "cache", charset: e.charset}, (function () {
  _$jscoverage['recipe.js'][19]++;
  F(e);
}));
    }
